...
internal fun UserListScreen(
    ...
    Scaffold(snackbarHost = {
        SnackbarHost(modifier = Modifier.testTag("SnackbarHost"), hostState = snackbarHostState)
    }) { paddingValues ->
        Column(modifier = Modifier.padding(paddingValues)) {
            ...
            PullToRefreshBox(
                modifier = Modifier.testTag("RefreshIndicator"),
...
private fun UserListScreenPreview() {
    PicPayTheme {
        UserListScreen(
            ...
            ), isLoading = true, onRefresh = {}, isRefreshing = false
        )
    }
}